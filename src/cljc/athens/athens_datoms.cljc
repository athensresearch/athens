...
;; TODO: when page/sidebar and block/open are supported in internal representation
;; remove block/uid for page, block/order for blocks, and use welcome-event in
;; local app startup.
(def welcome-page-datoms
  [{:block/uid "0",
    :node/title "Welcome",
    :page/sidebar 0,
