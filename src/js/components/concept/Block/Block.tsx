...
export const Block = ({
  ...
  const [showEditableDom, setRenderEditableDom] = React.useState<boolean>(
    false
  );
  const [
    avatarAnchorEl,
  ...
  return (
    <>
      ...
      >
        ...
        >
          {children && !isLocked && (
            <Toggle isOpen={isOpen} onClick={handlePressToggle} />
          )}
          <Anchor
        ...
        <>
          ...
          >
            <Avatar
              ...
              style={{
                filter:
                  "drop-shadow(0 2px 2px var(--shadow-color---opacity-lower))",
              }}
            />
          </Popper>
        </>
