  ...
  [{:node/title     "athens/Welcome",
    :block/children [{:block/string "Welcome to Athens, Open-Source Networked Thought!",
                     ...
                     {:block/string   "Right Sidebar",
                      ...
                      :db/id          369,
                      :block/order    5}
                     {:block/string "foo [[athens/Welcome]] and [[athens/Changelog]] are reserved pages. When a new version of Athens is deployed, your app will update automatically. These pages will be updated as well. Any changes you make to these pages will be overwritten, so don't write anything you need in these pages!",
                      :block/uid    "0250cd89f",
                      :block/open   true,
                      :db/id        377,
                      :block/order  6}],
